...
(function() {
  var Given, asFn, bind, defineGetter,
  ...
  Given = function(self) {
    var defineInBulk, defineOneVariable, entered, env, failOnReenter, funs, given, handler, isRedefinitionOf, isStackOverflowError, memoize, memos, privateEnv, redefine, resetEnv, topmostVariableBeingEvaluated, trapOuterEnvAccess, trapStackOverflow;
    privateEnv = {};
    env = self || {};
    funs = {};
    memos = {};
    ...
    handler = function(definitionFn, name) {
      var f1, f2, f3, f4;
    ...
    defineOneVariable = function(name, definition) {
      var definitionFn;
      if (name === 'given') {
