...
(function() {
  ...
  Given = {
    Env: function() {
      var defineInBulk, defineOneVariable, env, funs, given, illegallyAccessedVariable, isStackOverflowError, memoize, memos, privateEnv, redefine, resetEnv, trapOuterEnvAccess, trapStackOverflow;
      privateEnv = {};
      env = {};
      funs = {};
      memos = {};
