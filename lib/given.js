...
(function() {
  ...
  Given = function(self) {
    var define, defineInBulk, defineOneVariable, entered, env, failOnReenter, funs, given, isFirstDefinitionOf, isStackOverflowError, memoize, memos, privateEnv, redefine, resetEnv, topmostVariableBeingEvaluated, trapOuterEnvAccess, trapStackOverflow;
    privateEnv = {};
    env = self || {};
    funs = {};
    memos = {};
